...
#         name = text[i].text
#         links = [name.strip(), all_info, f'https://shop.casio.ru/{link}']
#         informarions.append(links)

#     with open('lesson_22/prac/clocks.json', 'a', encoding='utf-8') as file:
#         json.dump(informarions, file, indent=4, ensure_ascii=False)